					 ...
					 <div class="row">
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							...
							<div class="widget widget_archive">
                                ...
                                <ul>
                                    <li class="active"><a href="#">Formation gratuites</a></li>
						...
						<div class="col-lg-9 col-md-8 col-sm-12">
                            <h2>Nos formations Gratuites</h2><br/>
							<div class="row">
								<div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/cv.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">MONTER SON CV PROFFESSIONEL PAR AFRICKUP</a></h5>
                                ...
                                <div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/entretien.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">REUSSIR SON ENTRETIEN PAR LE STORYTELLING</a></h5>
											<span>Service gratuit</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
                                ...
                                <div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/idee.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">CHOISIR SON IDEE DE BUSINESS</a></h5>
											<span>Service gratuit</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
								...
								<div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/entreprenariat.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">SE LANCER DANS L'ENTREPRENARIAT PAR AFRICKUP</a></h5>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="row">
								...
								<div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/taxer.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">TAXER SES SERVICES OU SES PRODUITS</a></h5>
											<span>SERVICE PAYANT</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
                                ...
                                <div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/client.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">AMELIORER SON SERVICE CLIENTS</a></h5>
                                ...
                                <div class="col-md-6 col-lg-3 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<img src="{{asset('design/assets/images/incubateur.jpg')}}" alt="">
											<a href="#" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="#">INCUBATEUR D’ENTREPRISES ET DES STARTUP</a></h5>
											<span>Service payant</span>
										</div>
										<div class="cours-more-info">
											<div class="review">
