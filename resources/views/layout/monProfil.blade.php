                    ...
                    <div class="footer-links d-flex justify-content-between">
                            ...
                            <div class="linkcol">
                                ...
                                <div class="menu-company-container">
                                    <ul id="menu-company" class="menu">
                                        <li id="menu-item-1060" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1060"><a href="{{route('home')}}">Accueil</a></li>
                        ...
                        <div class="footer-right-link d-flex flex-column">
                            <div class="get-start">
                                ...
                                <a href="{{route('register_type')}}" class="sign-up">S'enregistrer</a>
                                <a href="{{route('login_view')}}" class="sign-in">Connexion</a> </div>
                        </div>
                    </div>
                </div>
            </div>
