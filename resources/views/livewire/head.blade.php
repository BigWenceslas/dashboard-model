				...
				<div class="">
					<div class="menu-main-menu-container">
						...
						<button class="navbar-toggler" id="bouton_derouleur" onclick="" type="button" data-toggle="collapse" data-target="#bloc_menu_header" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
							<img src="{{asset('storage/'.Auth::user()->avatar)}}" alt="icone_menu">
						</button>
						@endif
						<ul id="menu-main-menu" class="navbar-nav d-flex align-items-stretch justify-content-end">
							<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('apropos.liste.all',['locale' => App::getlocale()])}}">@lang('vitrine.pourquoi')</a></li>
							...
							@if (Auth::check() && Auth::user()->role_id == 1)
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="/admin" class="sign-up">@lang('vitrine.footer_profil')</a></li>
							@elseif(Auth::check() && Auth::user()->role_id == 3)
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('profile_etudiant',['locale' => App::getlocale()])}}" class="sign-up">@lang('vitrine.footer_profil')</a></li>
							@elseif(Auth::check() && Auth::user()->role_id == 4)
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('profile_entreprise',['locale' => App::getlocale()])}}" class="sign-up">@lang('vitrine.footer_profil')</a></li>
							@elseif(Auth::check() && Auth::user()->role_id == 5)
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('profile_freelance',['locale' => App::getlocale()])}}" class="sign-up">@lang('vitrine.footer_profil')</a></li>
							@elseif(Auth::check() && Auth::user()->role_id == 6)
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('profile_startup',['locale' => App::getlocale()])}}" class="sign-up">@lang('vitrine.footer_profil')</a></li>
							@endif
							@if (isset($viewname))
								@if ($viewname == "Accueil")
									@if (App::getlocale() != 'fr')
