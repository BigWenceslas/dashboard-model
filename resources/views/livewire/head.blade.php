				...
				<div class="">
					<div class="menu-main-menu-container">
						...
						<ul id="menu-main-menu" class="navbar-nav d-flex align-items-stretch justify-content-end">
							<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('apropos.liste.all',['locale' => App::getlocale()])}}">Pourquoi Africkup</a></li>
							...
							<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('fond_investissement',['locale' => App::getlocale()])}}">Fond D'investissement</a></li>
							...
							@if (!Auth::check())
								<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('login_view',['locale' => App::getlocale()])}}">Connexion</a></li>
							@endif
							<li id="menu-item-773" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-773"><a href="{{route('vitrine_multilangue',['locale' => App::getlocale()])}}">Vitrine multi-langue</a></li>
							@if (Auth::check())
