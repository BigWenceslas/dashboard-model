...
<body>
                ...
                <div class="tab-content" id="nav-tabContent">
                        <div id="vue_ensemble" class="tab-pane fade @if (!session('onglet')) show active @endif">
                            <div class="container_rubrique">
                                ...
                                <div class="corps_rubrique">
                                    ...
                                    <form action="{{route('freelance.description',['locale' => App::getlocale()])}}" method="post" enctype="multipart/form-data">
                                        @csrf
                        ...
                        <div id="information_complementaire" class="tab-pane fade @if (session('onglet') == 'informations') show active @endif">
                            <div class="container_rubrique">
                                ...
                                <div class="corps_rubrique">
                                    <p>Présentez-vous au monde entier et expliquez ce qui vous distingue des autres.</p>
                                    <form action="{{route('freelance.informations',['locale' => App::getlocale()])}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="sous_form">
                        ...
                        <div id="cursus_academique" class="tab-pane fade @if (session('onglet') == 'cursus_academique') show active @endif">
                            <div class="container_rubrique">
                                ...
                                @include('livewire.register.freelance.cursus_academique.create',['donnees_id' => $user->getUserData->id])
                                @include('livewire.register.freelance.cursus_academique.update',['donnees_id' => $user->getUserData->id])
                                @include('livewire.register.freelance.cursus_academique.cursus_academique',['donnees_id' => $user->getUserData->id])
                            </div>
                        </div>
                        <div id="experience_professionnelle" class="tab-pane fade @if (session('onglet') == 'experience_professionnelle') show active @endif">
                            <div class="container_rubrique">
                                ...
                                <div class="corps_rubrique">
                                    ...
                                    @include('livewire.register.freelance.experience_professionnelle.create',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.experience_professionnelle.update',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.experience_professionnelle.experience_professionnelle',['donnees_id' => $user->getUserData->id])
                                </div>
                            </div>
                        </div>
                        <div id="competences" class="tab-pane fade @if (session('onglet') == 'competences') show active @endif">
                            <div class="container_rubrique">
                                ...
                                <div class="corps_rubrique">
                                    ...
                                    @include('livewire.register.freelance.competence.create',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.competence.update',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.competence.competence',['donnees_id' => $user->getUserData->id])
                                </div>
                            </div>
                        </div>
                        <div id="references" class="tab-pane fade @if (session('onglet') == 'references') show active @endif">
                            <div class="container_rubrique">
                                ...
                                <div class="corps_rubrique">
                                    ...
                                    @include('livewire.register.freelance.reference.create',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.reference.update',['donnees_id' => $user->getUserData->id])
                                    @include('livewire.register.freelance.reference.reference',['donnees_id' => $user->getUserData->id])
                                </div>
                            </div>
                        </div>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.avatar-dropdown-menu').click(function(event){
