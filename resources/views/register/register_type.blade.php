...
<body class="home page-template page-template-template-hompage page-template-template-hompage-php page page-id-253 wp-embed-responsive singular image-filters-enabled responsive-menu-slide-left">
	<header class="bg-white">@livewire('head',['viewname' => 'creer_compte'])</header>
<main>
						...
						<div class="form-card">
							...
							<div class="row px-1 radio-group">
								...
								<div class="card-block text-center radio bloc_type_compte" id="bloc_freelance">
									<div class="image-icon"> <img class="icon icon1" src="{{asset('design/assets/img/freelance.png')}}" /></a>
									</div>
									<p class="sub-desc">Freelance</p>
								</div>
								<div class="card-block text-center radio bloc_type_compte" id="bloc_startup">
									<div class="image-icon"> <img class="icon icon1" src="{{asset('design/assets/img/startup.png')}}" /></a>
									</div>
									<p class="sub-desc">Startup</p>
								</div>
								<div class="card-block text-center radio bloc_type_compte" id="bloc_entreprise">
									<<div class="image-icon"> <img class="icon icon1" src="{{asset('design/assets/img/entreprise.png')}}" /></a>
								</div>
