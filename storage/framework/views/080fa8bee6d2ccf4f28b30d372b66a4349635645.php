                    ...
                    <div class="footer-links d-flex justify-content-between">
                            ...
                            <div class="linkcol">
                                ...
                                <div class="menu-company-container">
                                    <ul id="menu-company" class="menu">
                                        <li id="menu-item-1060" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1060"><a href="<?php echo e(route('home')); ?>">Accueil</a></li>
                                        <li id="menu-item-1149" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1149"><a href="<?php echo e(route('apropos.index')); ?>">Pourquoi choisir Africkup</a></li>
                                        <li id="menu-item-1063" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1063"><a href="<?php echo e(route('services.index')); ?>">Service</a></li>
                                        <li id="menu-item-1062" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1062"><a href="<?php echo e(route('formations.index')); ?>">Formation</a></li>
                                        ...
                                        <li id="menu-item-778" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-778"><a href="<?php echo e(route('contactus.index')); ?>">Contact</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="linkcol">
                        ...
                        <div class="footer-right-link d-flex flex-column">
                            <div class="get-start">
                                ...
                                <a href="<?php echo e(route('register_type')); ?>" class="sign-up">S'enregistrer</a>
                                <a href="<?php echo e(route('login_view')); ?>" class="sign-in">Connexion</a> </div>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\wamp64\www\dashboard-model\resources\views/layout/monProfil.blade.php ENDPATH**/ ?>