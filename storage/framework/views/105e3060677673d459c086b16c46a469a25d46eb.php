...
} elseif ($_instance->childHasBeenRendered('eE0fSfn')) {
    $componentId = $_instance->getRenderedChildComponentId('eE0fSfn');
    $componentTag = $_instance->getRenderedChildComponentTagName('eE0fSfn');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eE0fSfn');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'vue']);
    $dom = $response->dom;
    $_instance->logRenderedChild('eE0fSfn', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header> 
...
} elseif ($_instance->childHasBeenRendered('SeCvU87')) {
    $componentId = $_instance->getRenderedChildComponentId('SeCvU87');
    $componentTag = $_instance->getRenderedChildComponentTagName('SeCvU87');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SeCvU87');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('SeCvU87', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
...
</html><?php /**PATH C:\wamp64\www\dashboard-model\resources\views/fond/details.blade.php ENDPATH**/ ?>