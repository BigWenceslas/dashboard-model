...
} elseif ($_instance->childHasBeenRendered('CX7JMG9')) {
    $componentId = $_instance->getRenderedChildComponentId('CX7JMG9');
    $componentTag = $_instance->getRenderedChildComponentTagName('CX7JMG9');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CX7JMG9');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte_etudiant', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('CX7JMG9', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('Xdxk2i3')) {
    $componentId = $_instance->getRenderedChildComponentId('Xdxk2i3');
    $componentTag = $_instance->getRenderedChildComponentTagName('Xdxk2i3');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Xdxk2i3');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('Xdxk2i3', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
...
$(document).ready(function () {
 $('.form-wizard fieldset:first').fadeIn('slow');
	...
	<?php /**PATH C:\wamp64\www\afq\resources\views/register/etudiant/register_student.blade.php ENDPATH**/ ?>