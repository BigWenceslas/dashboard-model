...
<head>
  ...
  <?php echo \Livewire\Livewire::styles(); ?>
  	...
  	<link rel="stylesheet" href="<?php echo e(asset('design/parfait_integration/css/evenement.css')); ?>">
</head>

<body> <?php echo $__env->make('partials.site_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<header class="bg-white"> <?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('head',['viewname' => 'Evénement'])->dom;
} elseif ($_instance->childHasBeenRendered('2M41jqn')) {
    $componentId = $_instance->getRenderedChildComponentId('2M41jqn');
    $componentTag = $_instance->getRenderedChildComponentTagName('2M41jqn');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2M41jqn');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'Evénement']);
    $dom = $response->dom;
    $_instance->logRenderedChild('2M41jqn', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </header>
	<div class="container_card"> <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<div class="card_fond">
			<div class="container_photo_fond"> <img src="<?php echo e(asset('storage/'.$event->image)); ?>" alt="<?php echo e($event->titre); ?>"> </div>
			<h2 class="titre_fond"><?php echo e($event->titre); ?></h2>
			<p class="paragraphe_fond"><?php echo $event->descriptif; ?></p>
			<div class="container_bouton_learn"> <a href="#" class="learn_button bouton_africkup anul_lien" data-type="<?php echo e($event->type); ?>" data-toggle="modal" data-target="#<?php if($event->type == 'organisation'): ?><?php echo e("modal-dejeuner"); ?><?php else: ?><?php echo e("modal-dejeuner-intermediation"); ?><?php endif; ?>">Learn more</a> </div>
	...
	<div class="modal fade" id="modal-dejeuner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="container">
					<div class="text"> Contactez nous</div> <?php echo $__env->make('services.form_affaires', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </div>
			</div>
		</div>
	</div>
	<!-- Modal 2 -->
	<div class="modal fade" id="modal-dejeuner-intermediation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="container">
					<div class="text"> Contactez nous</div> <?php echo $__env->make('services.form_relation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> </div>
			</div>
		</div>
	</div>
...
} elseif ($_instance->childHasBeenRendered('qkNEPRW')) {
    $componentId = $_instance->getRenderedChildComponentId('qkNEPRW');
    $componentTag = $_instance->getRenderedChildComponentTagName('qkNEPRW');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qkNEPRW');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('qkNEPRW', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
  ...
  <?php echo \Livewire\Livewire::scripts(); ?> <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
