...
} elseif ($_instance->childHasBeenRendered('LZBCPgJ')) {
    $componentId = $_instance->getRenderedChildComponentId('LZBCPgJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('LZBCPgJ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LZBCPgJ');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'fond-investissement']);
    $dom = $response->dom;
    $_instance->logRenderedChild('LZBCPgJ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header>
...
} elseif ($_instance->childHasBeenRendered('gdY1OAp')) {
    $componentId = $_instance->getRenderedChildComponentId('gdY1OAp');
    $componentTag = $_instance->getRenderedChildComponentTagName('gdY1OAp');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('gdY1OAp');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('gdY1OAp', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
...
</html><?php /**PATH C:\wamp64\www\dashboard-model\resources\views/fond/index.blade.php ENDPATH**/ ?>