...
} elseif ($_instance->childHasBeenRendered('vGv5A7W')) {
    $componentId = $_instance->getRenderedChildComponentId('vGv5A7W');
    $componentTag = $_instance->getRenderedChildComponentTagName('vGv5A7W');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vGv5A7W');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'Accueil']);
    $dom = $response->dom;
    $_instance->logRenderedChild('vGv5A7W', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('vyW45IM')) {
    $componentId = $_instance->getRenderedChildComponentId('vyW45IM');
    $componentTag = $_instance->getRenderedChildComponentTagName('vyW45IM');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vyW45IM');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('vyW45IM', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	</footer>
...
<?php /**PATH C:\wamp64\www\afq\resources\views/welcome.blade.php ENDPATH**/ ?>