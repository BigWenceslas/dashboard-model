...
<?php $__env->startSection('title'); ?> Dashboard Startup <?php $__env->stopSection(); ?>
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div id="vue_ensemble" class="tab-pane fade show active">
                        <div class="container_rubrique">
                            ...
                            <div class="corps_rubrique">
                                ...
                                <form action="<?php echo e(route('startup.description',['locale' => App::getlocale()])); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <textarea placeholder="Description de la startup" class="description_text ckeditor" name="description_entreprise" id="description_entreprise" cols="30" rows="10"><?php echo $user->getUserData->description_entreprise; ?></textarea>
                    ...
                    <div id="presentation" class="tab-pane fade">
                        <div class="container_rubrique">
                            ...
                            <div class="corps_rubrique">
                                <p>Présentez-vous au monde entier et expliquez ce qui permet à votre Startup de se distinguer.</p>
                                <form action="<?php echo e(route('startup.presentation',['locale' => App::getlocale()])); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="sous_form">
                                        <div class="champ_court">
                                            <label for="nom">Nom:</label>
                                            <input type="text" class="champs_africkup" name="nom" placeholder="Nom de la startup" value="<?php echo e($user->getUserData->nom); ?>">
                                        </div>
                                        <div class="champ_court">
                                            <label for="adresse">Adresse:</label>
                                            <input type="text" class="champs_africkup" name="adresse" placeholder="Adresse de la startup" value="<?php echo e($user->getUserData->adresse); ?>">
                                        </div>
                                    </div>
                                    <div class="sous_form">
                                        <div class="champ_court">
                    ...
                    <div id="information_entreprise" class="tab-pane fade">
                        <div class="container_rubrique">
                            ...
                            <div class="corps_rubrique">
                                <p>Présentez-vous au monde entier et expliquez ce qui permet à votre Startup de se distinguer.</p>
                                <form action="<?php echo e(route('startup.informations',['locale' => App::getlocale()])); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="sous_form">
                                        <div class="champ_court">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.monProfil', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/afq/resources/views/register/startup/profile.blade.php ENDPATH**/ ?>