...
} elseif ($_instance->childHasBeenRendered('EndKUIE')) {
    $componentId = $_instance->getRenderedChildComponentId('EndKUIE');
    $componentTag = $_instance->getRenderedChildComponentTagName('EndKUIE');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EndKUIE');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'vue']);
    $dom = $response->dom;
    $_instance->logRenderedChild('EndKUIE', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header> 
...
} elseif ($_instance->childHasBeenRendered('5eOdzu9')) {
    $componentId = $_instance->getRenderedChildComponentId('5eOdzu9');
    $componentTag = $_instance->getRenderedChildComponentTagName('5eOdzu9');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5eOdzu9');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('5eOdzu9', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
