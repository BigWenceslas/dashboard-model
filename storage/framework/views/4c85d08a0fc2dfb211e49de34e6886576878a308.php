                                            ...
                                            <div class="action_corps">
                                                <div class="container_boutons_tableau">
                                                    <div class="bouton_tableau">
                                                        <a data-toggle="modal" href="#modalUpdate" class="anul_lien modalUpdate" data-id="<?php echo e($competence->id); ?>" data-titre="<?php echo e($competence->titre); ?>" data-description="<?php echo e($competence->descriptif); ?>">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right menu_action_responsive bloc_arrondi_blanc" aria-labelledby="menu1">
                                                        <button class="dropdown-item modalUpdate" data-toggle="modal" data-target="#modalUpdate" data-id="<?php echo e($competence->id); ?>" data-titre="<?php echo e($competence->id); ?>" data-description="<?php echo e($competence->id); ?>">
                                                            <span>Editer</span>
                                                            <i class="fa fa-pencil" aria-hidden="true"></i>
                                                        </button>
