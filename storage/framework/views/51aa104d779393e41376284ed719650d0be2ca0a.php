...
} elseif ($_instance->childHasBeenRendered('BobPFTc')) {
    $componentId = $_instance->getRenderedChildComponentId('BobPFTc');
    $componentTag = $_instance->getRenderedChildComponentTagName('BobPFTc');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BobPFTc');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('BobPFTc', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
<main>
...
} elseif ($_instance->childHasBeenRendered('K6ONZ4c')) {
    $componentId = $_instance->getRenderedChildComponentId('K6ONZ4c');
    $componentTag = $_instance->getRenderedChildComponentTagName('K6ONZ4c');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('K6ONZ4c');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('K6ONZ4c', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
