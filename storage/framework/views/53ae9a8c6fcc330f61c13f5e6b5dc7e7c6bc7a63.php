...
} elseif ($_instance->childHasBeenRendered('5MUyZSa')) {
    $componentId = $_instance->getRenderedChildComponentId('5MUyZSa');
    $componentTag = $_instance->getRenderedChildComponentTagName('5MUyZSa');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5MUyZSa');
} else {
    $response = \Livewire\Livewire::mount('head');
    $dom = $response->dom;
    $_instance->logRenderedChild('5MUyZSa', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('u6Ncwd0')) {
    $componentId = $_instance->getRenderedChildComponentId('u6Ncwd0');
    $componentTag = $_instance->getRenderedChildComponentTagName('u6Ncwd0');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('u6Ncwd0');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('u6Ncwd0', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
...
$(document).ready(function () {
 $('.form-wizard fieldset:first').fadeIn('slow');
	...
	<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/register/etudiant/register_student.blade.php ENDPATH**/ ?>