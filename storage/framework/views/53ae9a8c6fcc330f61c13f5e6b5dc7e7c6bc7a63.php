...
} elseif ($_instance->childHasBeenRendered('zXNay6O')) {
    $componentId = $_instance->getRenderedChildComponentId('zXNay6O');
    $componentTag = $_instance->getRenderedChildComponentTagName('zXNay6O');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zXNay6O');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte_etudiant', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('zXNay6O', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('JxCAcs9')) {
    $componentId = $_instance->getRenderedChildComponentId('JxCAcs9');
    $componentTag = $_instance->getRenderedChildComponentTagName('JxCAcs9');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JxCAcs9');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('JxCAcs9', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
