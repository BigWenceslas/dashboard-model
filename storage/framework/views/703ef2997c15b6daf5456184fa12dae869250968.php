...
} elseif ($_instance->childHasBeenRendered('1Xsc0kL')) {
    $componentId = $_instance->getRenderedChildComponentId('1Xsc0kL');
    $componentTag = $_instance->getRenderedChildComponentTagName('1Xsc0kL');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1Xsc0kL');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'contact-us']);
    $dom = $response->dom;
    $_instance->logRenderedChild('1Xsc0kL', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
</header>
...
} elseif ($_instance->childHasBeenRendered('xFDBzKO')) {
    $componentId = $_instance->getRenderedChildComponentId('xFDBzKO');
    $componentTag = $_instance->getRenderedChildComponentTagName('xFDBzKO');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xFDBzKO');
} else {
    $response = \Livewire\Livewire::mount('contact-form');
    $dom = $response->dom;
    $_instance->logRenderedChild('xFDBzKO', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
            </div>
...
} elseif ($_instance->childHasBeenRendered('1qlWO0G')) {
    $componentId = $_instance->getRenderedChildComponentId('1qlWO0G');
    $componentTag = $_instance->getRenderedChildComponentTagName('1qlWO0G');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1qlWO0G');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('1qlWO0G', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </footer>
