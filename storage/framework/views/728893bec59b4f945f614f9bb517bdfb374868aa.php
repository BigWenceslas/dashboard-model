						...
						<div class="footer-links d-flex justify-content-between">
								...
								<div class="linkcol">
									...
									<div class="menu-company-container">
										<ul id="menu-company" class="menu">
											<li id="menu-item-1060" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1060"><a href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('vitrine.footer_accueil'); ?></a></li>
											<li id="menu-item-1149" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1149"><a href="<?php echo e(route('apropos.index')); ?>"><?php echo app('translator')->get('vitrine.lien_pourquoi'); ?></a></li>
											<li id="menu-item-1063" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1063"><a href="<?php echo e(route('services.index')); ?>"><?php echo app('translator')->get('vitrine.footer_service'); ?></a></li>
											<li id="menu-item-1062" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1062"><a href="<?php echo e(route('formations.index')); ?>"><?php echo app('translator')->get('vitrine.footer_formation'); ?></a></li>
											...
											<li id="menu-item-778" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-778"><a href="<?php echo e(route('contactus.index')); ?>"><?php echo app('translator')->get('vitrine.footer_contact'); ?></a></li>
										</ul>
									</div>
								</div>
								<div class="linkcol">
							...
							<div class="footer-right-link d-flex flex-column">
								<div class="get-start">
									...
									<a href="<?php echo e(route('register_type')); ?>" class="sign-up"><?php echo app('translator')->get('vitrine.footer_inscription'); ?></a>
									<a href="<?php echo e(route('login_view')); ?>" class="sign-in"><?php echo app('translator')->get('vitrine.footer_connexion'); ?></a> </div>
							</div>
						</div>
					</div>
				</div>
