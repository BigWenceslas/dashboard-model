					...
					<div class="col">
						<div class="footer-links d-flex justify-content-between">
							...
							<div class="footer-right-link d-flex flex-column">
								<div class="get-start">
									<h5 class="font-weight-extraBold font-15">Demararer avec africkup</h5> <a href="<?php echo e(route('register_type')); ?>" class="sign-up">S'enregistrer</a> <a href="#" class="sign-in">Connexion</a> </div>
							</div>
						</div>
					</div>
				</div>
