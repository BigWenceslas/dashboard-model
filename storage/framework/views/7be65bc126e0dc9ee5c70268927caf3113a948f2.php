...
<div class="modal fade" id="referenceUpdateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel2" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(route('etudiant.reference.update',['locale' => App::getLocale()])); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/livewire/register/etudiant/reference/update.blade.php ENDPATH**/ ?>