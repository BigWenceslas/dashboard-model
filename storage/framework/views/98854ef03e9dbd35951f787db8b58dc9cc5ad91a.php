...
} elseif ($_instance->childHasBeenRendered('Hqh3H2Y')) {
    $componentId = $_instance->getRenderedChildComponentId('Hqh3H2Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('Hqh3H2Y');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Hqh3H2Y');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'a-propos']);
    $dom = $response->dom;
    $_instance->logRenderedChild('Hqh3H2Y', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </header>
...
} elseif ($_instance->childHasBeenRendered('18D0Pw6')) {
    $componentId = $_instance->getRenderedChildComponentId('18D0Pw6');
    $componentTag = $_instance->getRenderedChildComponentTagName('18D0Pw6');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('18D0Pw6');
} else {
    $response = \Livewire\Livewire::mount('liste-entreprises');
    $dom = $response->dom;
    $_instance->logRenderedChild('18D0Pw6', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </section>
...
} elseif ($_instance->childHasBeenRendered('iqqtTYw')) {
    $componentId = $_instance->getRenderedChildComponentId('iqqtTYw');
    $componentTag = $_instance->getRenderedChildComponentTagName('iqqtTYw');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('iqqtTYw');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('iqqtTYw', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
		</footer>
