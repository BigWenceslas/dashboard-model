...
} elseif ($_instance->childHasBeenRendered('S7sLuD0')) {
    $componentId = $_instance->getRenderedChildComponentId('S7sLuD0');
    $componentTag = $_instance->getRenderedChildComponentTagName('S7sLuD0');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('S7sLuD0');
} else {
    $response = \Livewire\Livewire::mount('head');
    $dom = $response->dom;
    $_instance->logRenderedChild('S7sLuD0', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </header> 
...
} elseif ($_instance->childHasBeenRendered('GR6bbfH')) {
    $componentId = $_instance->getRenderedChildComponentId('GR6bbfH');
    $componentTag = $_instance->getRenderedChildComponentTagName('GR6bbfH');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GR6bbfH');
} else {
    $response = \Livewire\Livewire::mount('liste-services');
    $dom = $response->dom;
    $_instance->logRenderedChild('GR6bbfH', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </main>
...
} elseif ($_instance->childHasBeenRendered('LN5VTdH')) {
    $componentId = $_instance->getRenderedChildComponentId('LN5VTdH');
    $componentTag = $_instance->getRenderedChildComponentTagName('LN5VTdH');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LN5VTdH');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('LN5VTdH', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </footer>
