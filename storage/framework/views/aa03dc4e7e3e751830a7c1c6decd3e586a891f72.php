...
<div class="modal fade" id="expCreateModal" tabindex="-1" role="dialog" aria-labelledby="expCreateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method="post" action="<?php echo e(route('etudiant.experience_professionnelle.create',['locale' => App::getLocale()])); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/livewire/register/etudiant/experience_professionnelle/create.blade.php ENDPATH**/ ?>