...
<?php $__env->startSection('left-menu'); ?>
     <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							...
							<div class="widget widget_archive">
                                ...
                                <ul>
                                    <li class="active"><a href="<?php echo e(route('apropos.index')); ?>#liste-entreprises">Liste des entreprise</a></li>
                                </ul>
                            </div>
							<div class="widget">
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div class="action-box">
											<div class="video-responsive"><img src="<?php echo e(asset('public/storage/'.$entreprise->logo)); ?>" alt="">
                                            </div>
										</div>
