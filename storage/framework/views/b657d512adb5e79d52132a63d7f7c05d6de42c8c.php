...
} elseif ($_instance->childHasBeenRendered('Amf35tX')) {
    $componentId = $_instance->getRenderedChildComponentId('Amf35tX');
    $componentTag = $_instance->getRenderedChildComponentTagName('Amf35tX');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Amf35tX');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('Amf35tX', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
<main>
...
} elseif ($_instance->childHasBeenRendered('M8afRWH')) {
    $componentId = $_instance->getRenderedChildComponentId('M8afRWH');
    $componentTag = $_instance->getRenderedChildComponentTagName('M8afRWH');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('M8afRWH');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('M8afRWH', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
	...
	<?php /**PATH C:\wamp64\www\afq\resources\views/register/register_type.blade.php ENDPATH**/ ?>