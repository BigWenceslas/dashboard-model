...
} elseif ($_instance->childHasBeenRendered('E6zClPF')) {
    $componentId = $_instance->getRenderedChildComponentId('E6zClPF');
    $componentTag = $_instance->getRenderedChildComponentTagName('E6zClPF');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('E6zClPF');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'vue']);
    $dom = $response->dom;
    $_instance->logRenderedChild('E6zClPF', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header> 
			...
			<div class="section-area section-sp1">
                <div class="container">
						...
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							...
							<div class="widget widget_archive">
                                ...
                                <ul>
                                    ...
                                    <?php if($loop->first): ?>
                                    <li class="active"><a href="<?php echo e(route('services.index')); ?>#category--<?php echo e($item->id); ?>"><?php echo e($item->nom); ?></a></li>
                                    <?php else: ?>
                                        <li><a href="<?php echo e(route('services.index')); ?>#category--<?php echo e($item->id); ?>"><?php echo e($item->nom); ?></a></li>
                                    <?php endif; ?>
                     ...
                     Utilisez ce rapport pour indiquer la valeur de votre entreprise pour augmenter vos actions, faire des ameliorations, informer vos potentiels investisseurs.<br/>
								...
								<?php
if (! isset($_instance)) {
    $dom = \Livewire\Livewire::mount('evaluation-service')->dom;
} elseif ($_instance->childHasBeenRendered('SBw7Pij')) {
    $componentId = $_instance->getRenderedChildComponentId('SBw7Pij');
    $componentTag = $_instance->getRenderedChildComponentTagName('SBw7Pij');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SBw7Pij');
} else {
    $response = \Livewire\Livewire::mount('evaluation-service');
    $dom = $response->dom;
    $_instance->logRenderedChild('SBw7Pij', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                            </div>
...
} elseif ($_instance->childHasBeenRendered('86Ow4vP')) {
    $componentId = $_instance->getRenderedChildComponentId('86Ow4vP');
    $componentTag = $_instance->getRenderedChildComponentTagName('86Ow4vP');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('86Ow4vP');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('86Ow4vP', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
