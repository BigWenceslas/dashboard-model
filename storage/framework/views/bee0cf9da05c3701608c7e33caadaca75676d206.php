...
} elseif ($_instance->childHasBeenRendered('eMkCHpr')) {
    $componentId = $_instance->getRenderedChildComponentId('eMkCHpr');
    $componentTag = $_instance->getRenderedChildComponentTagName('eMkCHpr');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('eMkCHpr');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'services']);
    $dom = $response->dom;
    $_instance->logRenderedChild('eMkCHpr', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </header> 
...
} elseif ($_instance->childHasBeenRendered('KUnnIYm')) {
    $componentId = $_instance->getRenderedChildComponentId('KUnnIYm');
    $componentTag = $_instance->getRenderedChildComponentTagName('KUnnIYm');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KUnnIYm');
} else {
    $response = \Livewire\Livewire::mount('liste-services');
    $dom = $response->dom;
    $_instance->logRenderedChild('KUnnIYm', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </main>
...
} elseif ($_instance->childHasBeenRendered('xNy312b')) {
    $componentId = $_instance->getRenderedChildComponentId('xNy312b');
    $componentTag = $_instance->getRenderedChildComponentTagName('xNy312b');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xNy312b');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('xNy312b', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
        </footer>
