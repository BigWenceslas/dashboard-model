...
<div class="modal fade" id="cursusAcademiqueUpdateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel2" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo e(route('etudiant.cursus_academique.update',['locale' => App::getLocale()])); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/livewire/register/etudiant/cursus_academique/update.blade.php ENDPATH**/ ?>