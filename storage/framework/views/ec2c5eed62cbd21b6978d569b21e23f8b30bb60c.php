									...
									<div class="inner_sidebar"> <a href="javascript:void(0)" class="btn  "> Liste des entreprises</a>
										<div class="sidebar_wrap">
											...
											<div class="single_sidebar">
												...
												<ul class="no-ul-list">
													<li>
														<input id="ct-1" class="checkbox-custom filtre-ville" name="ct-1" type="checkbox">
														<label for="ct-1" class="checkbox-custom-label">Douala - 10</label>
													</li>
													<li>
														<input id="ct-2" class="checkbox-custom" name="ct-1" type="checkbox">
														<label for="ct-2" class="checkbox-custom-label">Yaounde - 12</label>
													</li>
													<li>
														<input id="ct-3" class="checkbox-custom" name="ct-1" type="checkbox">
...
</html><?php /**PATH /opt/lampp/htdocs/afq/resources/views/apropos/a_propos.blade.php ENDPATH**/ ?>