...
} elseif ($_instance->childHasBeenRendered('41RlJKE')) {
    $componentId = $_instance->getRenderedChildComponentId('41RlJKE');
    $componentTag = $_instance->getRenderedChildComponentTagName('41RlJKE');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('41RlJKE');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'formations']);
    $dom = $response->dom;
    $_instance->logRenderedChild('41RlJKE', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header> 
...
} elseif ($_instance->childHasBeenRendered('mUL1miS')) {
    $componentId = $_instance->getRenderedChildComponentId('mUL1miS');
    $componentTag = $_instance->getRenderedChildComponentTagName('mUL1miS');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('mUL1miS');
} else {
    $response = \Livewire\Livewire::mount('liste-formations');
    $dom = $response->dom;
    $_instance->logRenderedChild('mUL1miS', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </main>
...
} elseif ($_instance->childHasBeenRendered('JkBLJWe')) {
    $componentId = $_instance->getRenderedChildComponentId('JkBLJWe');
    $componentTag = $_instance->getRenderedChildComponentTagName('JkBLJWe');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JkBLJWe');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('JkBLJWe', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
