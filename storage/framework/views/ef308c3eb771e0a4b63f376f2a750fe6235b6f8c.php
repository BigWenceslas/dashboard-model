...
} elseif ($_instance->childHasBeenRendered('dU3iB0w')) {
    $componentId = $_instance->getRenderedChildComponentId('dU3iB0w');
    $componentTag = $_instance->getRenderedChildComponentTagName('dU3iB0w');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dU3iB0w');
} else {
    $response = \Livewire\Livewire::mount('head');
    $dom = $response->dom;
    $_instance->logRenderedChild('dU3iB0w', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </header>
...
} elseif ($_instance->childHasBeenRendered('Q7cSsEH')) {
    $componentId = $_instance->getRenderedChildComponentId('Q7cSsEH');
    $componentTag = $_instance->getRenderedChildComponentTagName('Q7cSsEH');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Q7cSsEH');
} else {
    $response = \Livewire\Livewire::mount('liste-entreprises');
    $dom = $response->dom;
    $_instance->logRenderedChild('Q7cSsEH', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </section>
...
} elseif ($_instance->childHasBeenRendered('JO2cT19')) {
    $componentId = $_instance->getRenderedChildComponentId('JO2cT19');
    $componentTag = $_instance->getRenderedChildComponentTagName('JO2cT19');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JO2cT19');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('JO2cT19', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	</footer>
