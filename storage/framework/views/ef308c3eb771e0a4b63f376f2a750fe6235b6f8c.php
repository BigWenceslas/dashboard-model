...
} elseif ($_instance->childHasBeenRendered('azx4Wkg')) {
    $componentId = $_instance->getRenderedChildComponentId('azx4Wkg');
    $componentTag = $_instance->getRenderedChildComponentTagName('azx4Wkg');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('azx4Wkg');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'a-propos']);
    $dom = $response->dom;
    $_instance->logRenderedChild('azx4Wkg', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </header>
...
} elseif ($_instance->childHasBeenRendered('zO4fbIz')) {
    $componentId = $_instance->getRenderedChildComponentId('zO4fbIz');
    $componentTag = $_instance->getRenderedChildComponentTagName('zO4fbIz');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zO4fbIz');
} else {
    $response = \Livewire\Livewire::mount('liste-entreprises');
    $dom = $response->dom;
    $_instance->logRenderedChild('zO4fbIz', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </section>
...
} elseif ($_instance->childHasBeenRendered('n6PZQRV')) {
    $componentId = $_instance->getRenderedChildComponentId('n6PZQRV');
    $componentTag = $_instance->getRenderedChildComponentTagName('n6PZQRV');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n6PZQRV');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('n6PZQRV', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	</footer>
