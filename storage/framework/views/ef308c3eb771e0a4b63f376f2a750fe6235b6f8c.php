...
} elseif ($_instance->childHasBeenRendered('t56ib26')) {
    $componentId = $_instance->getRenderedChildComponentId('t56ib26');
    $componentTag = $_instance->getRenderedChildComponentTagName('t56ib26');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('t56ib26');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'a-propos']);
    $dom = $response->dom;
    $_instance->logRenderedChild('t56ib26', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </header>
...
} elseif ($_instance->childHasBeenRendered('30umJCQ')) {
    $componentId = $_instance->getRenderedChildComponentId('30umJCQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('30umJCQ');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('30umJCQ');
} else {
    $response = \Livewire\Livewire::mount('liste-entreprises');
    $dom = $response->dom;
    $_instance->logRenderedChild('30umJCQ', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </section>
...
} elseif ($_instance->childHasBeenRendered('VphcC1L')) {
    $componentId = $_instance->getRenderedChildComponentId('VphcC1L');
    $componentTag = $_instance->getRenderedChildComponentTagName('VphcC1L');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VphcC1L');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('VphcC1L', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
		</footer>
