...
} elseif ($_instance->childHasBeenRendered('rztJl3p')) {
    $componentId = $_instance->getRenderedChildComponentId('rztJl3p');
    $componentTag = $_instance->getRenderedChildComponentTagName('rztJl3p');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rztJl3p');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte_etudiant', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('rztJl3p', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('72Rtkf5')) {
    $componentId = $_instance->getRenderedChildComponentId('72Rtkf5');
    $componentTag = $_instance->getRenderedChildComponentTagName('72Rtkf5');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('72Rtkf5');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('72Rtkf5', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
