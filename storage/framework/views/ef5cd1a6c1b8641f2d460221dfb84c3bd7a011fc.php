...
} elseif ($_instance->childHasBeenRendered('MRlBBli')) {
    $componentId = $_instance->getRenderedChildComponentId('MRlBBli');
    $componentTag = $_instance->getRenderedChildComponentTagName('MRlBBli');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MRlBBli');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte_etudiant', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('MRlBBli', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('w301CLz')) {
    $componentId = $_instance->getRenderedChildComponentId('w301CLz');
    $componentTag = $_instance->getRenderedChildComponentTagName('w301CLz');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('w301CLz');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('w301CLz', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
