...
} elseif ($_instance->childHasBeenRendered('2xMPqD6')) {
    $componentId = $_instance->getRenderedChildComponentId('2xMPqD6');
    $componentTag = $_instance->getRenderedChildComponentTagName('2xMPqD6');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2xMPqD6');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'formations']);
    $dom = $response->dom;
    $_instance->logRenderedChild('2xMPqD6', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </header> 
...
} elseif ($_instance->childHasBeenRendered('Y50Qsuw')) {
    $componentId = $_instance->getRenderedChildComponentId('Y50Qsuw');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y50Qsuw');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y50Qsuw');
} else {
    $response = \Livewire\Livewire::mount('liste-formations');
    $dom = $response->dom;
    $_instance->logRenderedChild('Y50Qsuw', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </main>
...
} elseif ($_instance->childHasBeenRendered('ApaYeIU')) {
    $componentId = $_instance->getRenderedChildComponentId('ApaYeIU');
    $componentTag = $_instance->getRenderedChildComponentTagName('ApaYeIU');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ApaYeIU');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('ApaYeIU', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
  </footer>
