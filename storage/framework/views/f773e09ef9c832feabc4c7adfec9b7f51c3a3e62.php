...
} elseif ($_instance->childHasBeenRendered('rOwxMXp')) {
    $componentId = $_instance->getRenderedChildComponentId('rOwxMXp');
    $componentTag = $_instance->getRenderedChildComponentTagName('rOwxMXp');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rOwxMXp');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('rOwxMXp', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
<main>
...
} elseif ($_instance->childHasBeenRendered('qZtD4Ni')) {
    $componentId = $_instance->getRenderedChildComponentId('qZtD4Ni');
    $componentTag = $_instance->getRenderedChildComponentTagName('qZtD4Ni');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qZtD4Ni');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('qZtD4Ni', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
