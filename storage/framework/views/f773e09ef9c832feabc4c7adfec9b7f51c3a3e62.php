...
} elseif ($_instance->childHasBeenRendered('zvkZDdI')) {
    $componentId = $_instance->getRenderedChildComponentId('zvkZDdI');
    $componentTag = $_instance->getRenderedChildComponentTagName('zvkZDdI');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zvkZDdI');
} else {
    $response = \Livewire\Livewire::mount('head');
    $dom = $response->dom;
    $_instance->logRenderedChild('zvkZDdI', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
<main>
...
} elseif ($_instance->childHasBeenRendered('Es1cUzx')) {
    $componentId = $_instance->getRenderedChildComponentId('Es1cUzx');
    $componentTag = $_instance->getRenderedChildComponentTagName('Es1cUzx');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Es1cUzx');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('Es1cUzx', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
