...
} elseif ($_instance->childHasBeenRendered('McPcL6Y')) {
    $componentId = $_instance->getRenderedChildComponentId('McPcL6Y');
    $componentTag = $_instance->getRenderedChildComponentTagName('McPcL6Y');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('McPcL6Y');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'creer_compte', 'locale' => App::getlocale()]);
    $dom = $response->dom;
    $_instance->logRenderedChild('McPcL6Y', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
<main>
...
} elseif ($_instance->childHasBeenRendered('RNmcY4z')) {
    $componentId = $_instance->getRenderedChildComponentId('RNmcY4z');
    $componentTag = $_instance->getRenderedChildComponentTagName('RNmcY4z');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RNmcY4z');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('RNmcY4z', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?> </footer>
	...
	<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/register/register_type.blade.php ENDPATH**/ ?>