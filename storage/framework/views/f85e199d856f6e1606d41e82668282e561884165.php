...
<div class="modal fade" id="cursusAcademiqueCreateModal" tabindex="-1" role="dialog" aria-labelledby="cursusAcademiqueCreateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <form method="post" action="<?php echo e(route('etudiant.cursus_academique.create',['locale' => App::getLocale()])); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wamp64\www\dashboard-model\resources\views/livewire/register/etudiant/cursus_academique/create.blade.php ENDPATH**/ ?>