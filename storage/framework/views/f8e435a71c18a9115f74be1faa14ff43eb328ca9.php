...
} elseif ($_instance->childHasBeenRendered('aqz7sRi')) {
    $componentId = $_instance->getRenderedChildComponentId('aqz7sRi');
    $componentTag = $_instance->getRenderedChildComponentTagName('aqz7sRi');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('aqz7sRi');
} else {
    $response = \Livewire\Livewire::mount('head',['viewname' => 'Accueil']);
    $dom = $response->dom;
    $_instance->logRenderedChild('aqz7sRi', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?></header>
...
} elseif ($_instance->childHasBeenRendered('5hkuYLi')) {
    $componentId = $_instance->getRenderedChildComponentId('5hkuYLi');
    $componentTag = $_instance->getRenderedChildComponentTagName('5hkuYLi');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5hkuYLi');
} else {
    $response = \Livewire\Livewire::mount('footer');
    $dom = $response->dom;
    $_instance->logRenderedChild('5hkuYLi', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
	</footer>
